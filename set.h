...
void deallocate( treenode* n ); //given
   // Deallocate complete tree n.

void writecopy( treenode** to, treenode* from ); //given
...
void print( std::ostream& out, const treenode* n, size_t indent ); //given
...
public:
   ...
   std::ostream& print( size_t indent, std::ostream& out ) const; //done
};
